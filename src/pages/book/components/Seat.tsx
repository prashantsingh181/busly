...
export default function Seat({
  ...
  const selectedSeatClassName =
    "w-[3rem] w-[3.25rem] border-2 border-theme-500 bg-theme-100 text-theme-700 rounded-lg grid place-items-center aspect-square relative";
  const soldSeatClassName =
    "w-[3rem] w-[3.25rem] border-2 border-neutral-200 bg-neutral-300 text-neutral-700 rounded-lg grid place-items-center aspect-square cursor-not-allowed relative";
  return (
    <button
      className={
        isSold
